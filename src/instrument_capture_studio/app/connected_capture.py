...
def run_connected_capture(
    ...
    *,
    ...
    """Run one complete Capture Job on adapters that are already connected.

    This is the long-session variant used by frequency sweep / batch capture.
    It deliberately does not connect or disconnect either instrument.
    """
